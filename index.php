  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      ...
      <div class="btns">
        ...
        <a href="pages/jobfinder.php"><i class="fa fa-play fa-3x"></i> Job Portal</a>
        <a href="pages/marketplace.php"><i class="fa fa-windows fa-3x"></i> Marketplace</a>
      </div>
    </div>
    ...
    <section id="about-us" class="about-us padd-section">
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-md-5 col-lg-5">
            <img src="assets/img/about.png" alt="About" data-aos="zoom-in" data-aos-delay="100">
          </div>

          <div class="col-md-7 col-lg-5">
            <div class="about-content" data-aos="fade-left" data-aos-delay="100">

              <h2><span>Project NEW-DAWN</span></h2>
