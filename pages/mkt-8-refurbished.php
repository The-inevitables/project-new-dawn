   ...
   <!--Main page-->
      <div class="main h-full flex">
          ...
          <div class="main-section w-40  border-t flex-1 p-6 bg-gray-100">
              <!--Adding a banner-->
              <div class="w-full main-section-banner-refgoods h-44 rounded-lg flex items-end ">
                  <div class="button bg-white w-36 h-10 rounded-full flex justify-center items-center ml-4 cursor-pointer mb-2">
                      <h4 class="text-bold italic text-blue-700">Refurbished goods</h4>
                  </div>
                ...
                <div class="main-section-products bg-gray-100 w-full flex">
                    ...
                    <div class="main-product-1">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://m.media-amazon.com/images/I/71c2tfyvheL._AC_UL480_QL65_.jpg" alt="image">
                        </div>
                    ...
                    <div class="main-product-1 ml-5">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://m.media-amazon.com/images/I/61D8YXadlSS._AC_UL480_QL65_.jpg" alt="image">
                        </div>
                        <div class="product-name font-bold text-gray-700 mt-2 text-sm">
                           TP Link Cam
                        </div>
                    ...
                    <div class="main-product-1 ml-5">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://m.media-amazon.com/images/I/71rOzy4cyAL._AC_UY327_FMwebp_QL65_.jpg" alt="image">
                        </div>
                        <div class="product-name font-bold text-gray-700 mt-2 text-sm">
                           Harry Potter
                        </div>
                    ...
                    <div class="main-product-1 ml-5">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://m.media-amazon.com/images/I/71keoWUVGvL._AC_UY327_FMwebp_QL65_.jpg" alt="image">
                        </div>
                        <div class="product-name font-bold text-gray-700 mt-2 text-sm">
                        U-stand
                        </div>
          ...
          <div class=" border-t-2 border-r-2 border-opacity-20 border-gray-700 main-sidebar w-1.5/5  bg-white p-6">
            <!--Categories for side bar-->
              <div class="sidebar-categories">
                ...
                <div class="sidebar-main-category cursor-pointer flex rounded-lg  font-bold  hover:bg-gray-200  text-black  mb-2 p-2">
                ...
                <div class="sidebar-main-category cursor-pointer flex rounded-lg font-bold text-black  bg-gray-200 mb-2 p-2">
