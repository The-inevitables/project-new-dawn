          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Communities</p>
                    <h5 class="font-weight-bolder mb-0">
                      1465
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold">Built by community</p>
                    <br/>
                    <h5 class="font-weight-bolder">Community Newsletter</h5>
                    <p class="mb-5">Wants to know what's happening around you?  
        ...
        <!-- <div class="col-lg-7">
          <div class="card z-index-2">
            ...
            <div class="card-body p-3">
              ...
              <!-- end of Chart Over view  -->
 <!-- start of Market place view  -->
      <div class="row my-4">
