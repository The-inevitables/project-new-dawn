   ...
   <!--Main page-->
      <div class="main h-full flex">
          ...
          <div class="main-section w-40  border-t flex-1 p-6 bg-gray-100">
              <!--Adding a banner-->
              <div class="w-full main-section-banner-home h-44 rounded-lg flex items-end ">
                  <div class="button bg-white w-36 h-10 rounded-full flex justify-center items-center ml-4 cursor-pointer mb-2">
                      <h4 class="text-bold italic text-yellow-600">Home & Furniture</h4>
                  </div>
                ...
                <div class="main-section-products bg-gray-100 w-full flex">
                    ...
                    <div class="main-product-1">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://m.media-amazon.com/images/I/61FDEuawBdL._AC_UL480_FMwebp_QL65_.jpg" alt="image">
                        </div>
                    ...
                    <div class="main-product-1 ml-5">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://m.media-amazon.com/images/I/81QF85U0tPL._AC_UL480_FMwebp_QL65_.jpg" alt="image">
                        </div>
                        <div class="product-name font-bold text-gray-700 mt-2 text-sm">
                           TV Unit
                        </div>
                    ...
                    <div class="main-product-1 ml-5">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://m.media-amazon.com/images/I/71dxDIrlAhL._AC_UL480_FMwebp_QL65_.jpg" alt="image">
                        </div>
                        <div class="product-name font-bold text-gray-700 mt-2 text-sm">
                           Wine Rack
                        </div>
