        ...
        <div class="col-12 mt-4">
          <div class="card mb-4">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-1">Find= "Plumbers"</h6>
                  ...
                  <div class="card card-blog card-plain">
                    ...
                    <div class="card-body px-1 pb-0">
                      ...
                      <p class="mb-4 text-sm">
                        Plumbing * Water Leakage * New House Contractor Works 
                      </p>
                      
                      <p class="mb-4 text-sm">
                        Contact: +919947895623
                      </p>
                      <p class="mb-4 text-sm">
                ...
                <div class="col-xl-4 col-md-6 mb-xl-0 mb-4">
                  <div class="card card-blog card-plain">
                    ...
                    <div class="card-body px-1 pb-0">
                      ...
                      <p class="mb-4 text-sm">
                        Plumbing *  Plumbing Shops * Water Leakage
                      </p>
                ...
                <div class="col-xl-4 col-md-6 mb-xl-0 mb-4">
                  <div class="card card-blog card-plain">
                    ...
                    <div class="card-body px-1 pb-0">
                      ...
                      <p class="mb-4 text-sm">
                      Plumbing * Degree in Electrical and Plumbing
                      </p>
