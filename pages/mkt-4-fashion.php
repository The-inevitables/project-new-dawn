   ...
   <!--Main page-->
      <div class="main h-full flex">
          ...
          <div class="main-section w-40  border-t flex-1 p-6 bg-gray-100">
              <!--Adding a banner-->
              <div class="w-full main-section-banner-fash h-44 rounded-lg flex items-end ">
                  <div class="button bg-white w-36 h-10 rounded-full flex justify-center items-center ml-4 cursor-pointer mb-2">
                      <h4 class="text-bold italic text-red-400">Fashion</h4>
                  </div>
                ...
                <div class="main-section-products bg-gray-100 w-full flex">
                    ...
                    <div class="main-product-1">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://m.media-amazon.com/images/I/81qlnA0rJEL._AC_UL480_FMwebp_QL65_.jpg" alt="image">
                        </div>
                    ...
                    <div class="main-product-1 ml-5">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://assets.myntassets.com/f_webp,dpr_1.5,q_60,w_210,c_limit,fl_progressive/assets/images/12951194/2020/12/3/c46c5f79-59e9-42a4-9240-c2b9fea2275a1606994240109-Puma-Men-Sports-Sandals-8001606994238504-1.jpg" alt="image">
                        </div>
                        <div class="product-name font-bold text-gray-700 mt-2 text-sm">
                            Casual sandals
                        </div>
                    ...
                    <div class="main-product-1 ml-5">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://assets.myntassets.com/f_webp,dpr_1.5,q_60,w_210,c_limit,fl_progressive/assets/images/15828674/2021/10/17/1fa086a4-0ca6-4e55-bd30-ad076c791fb81634431595710MyshkaWomenBlackPanelledPureCottonKurtiwithPalazzosWithDupat1.jpg" alt="image">
                        </div>
                        <div class="product-name font-bold text-gray-700 mt-2 text-sm">
                            Kurta
                        </div>
                    ...
                    <div class="main-product-1 ml-5">
                        ...
                        <div class="product-image w-48 h-52 rounded-lg bg-white p-4">
                            <img class="w-full h-full object-contain "src="https://assets.myntassets.com/f_webp,dpr_1.5,q_60,w_210,c_limit,fl_progressive/assets/images/14633472/2021/8/5/029a6d75-f6b8-42db-8f99-866b8b81e87a1628163856748-INVICTUS-Men-Blazers-8991628163855916-1.jpg" alt="image">
                        </div>
                        <div class="product-name font-bold text-gray-700 mt-2 text-sm">
                        Blazer
                        </div>
          ...
          <div class=" border-t-2 border-r-2 border-opacity-20 border-gray-700 main-sidebar w-1.5/5  bg-white p-6">
            <!--Categories for side bar-->
              ...
              <a href="marketplace.php">
                ...
                <div class="sidebar-main-category cursor-pointer  rounded-lg flex font-bold text-black bg-gray-200  mb-2 p-2">
