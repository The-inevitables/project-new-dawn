              ...
              <div class="row">
                  ...
                  <div class="card card-blog card-plain">
                    <div class="position-relative">
                      <a class="d-block shadow-xl border-radius-xl">
                        <img src="../assets/img/developer.jpg" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                      </a>
                    </div>
                    <div class="card-body px-1 pb-0">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        <a href="devclub.php" type="button" class="btn btn-outline-primary btn-sm mb-0">Go To  Club</a>
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                  <div class="card card-blog card-plain">
                    <div class="position-relative">
                      <a class="d-block shadow-xl border-radius-xl">
                        <img src="../assets/img/charity.jpg" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg">
                      </a>
                    </div>
                    <div class="card-body px-1 pb-0">
                      <p class="text-gradient text-dark mb-2 text-sm"></p>
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        <a href="charity.php" type="button" class="btn btn-outline-primary btn-sm mb-0">Go To  Club</a>
                        <div class="avatar-group mt-2">
                          <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Nick Daniel">
                            <img alt="Image placeholder" src="../assets/img/team-3.jpg">
                          </a>
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                  <div class="card card-blog card-plain">
                    ...
                    <div class="card-body px-1 pb-0">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        <a href="readers.php" type="button" class="btn btn-outline-primary btn-sm mb-0">Go To Club </a>
                        <div class="avatar-group mt-2">
                          <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Peterson">
                            <img alt="Image placeholder" src="../assets/img/team-4.jpg">
                          </a>
                  ...
                  <div class="card h-100 card-plain border">
                    <div class="card-body d-flex flex-column justify-content-center text-center">
                      <a href="clubs.php">
                        ...
                        <h5 class=" text-secondary"> Explore new Clubs </h5>
                      </a>
                    </div>
                  </div>
                </div>
