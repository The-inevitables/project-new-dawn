  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active " href="../pages/myfriends.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Azure & Backend Team Lead</p>
                        <p class="text-xs text-secondary mb-0">Project New Dawn</p>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Full Stack Developer</p>
                        <p class="text-xs text-secondary mb-0">Project New Dawn</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">UI/UX Lead</p>
                        <p class="text-xs text-secondary mb-0">Project New Dawn</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">Online</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Team Lead</p>
                        <p class="text-xs text-secondary mb-0">Project New Dawn</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">Online</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Associate Manager</p>
                        <p class="text-xs text-secondary mb-0">Project New Dawn</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-secondary">Offline</span>
      ...
      <div class="col-5 col-xl-5">
          <div class="card h-100">
            ...
            <i class="lni lni-comments"></i>
                  ...
                  <div id="weavy-chat" style="height:50vh;"></div>
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-3 pt-2 pb-4">
              ...
              <iframe src="https://open.spotify.com/embed/playlist/37i9dQZF1DXcdlzLQY4jm1?utm_source=generator&theme=0" width="100%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
