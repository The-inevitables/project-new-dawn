            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Join Us!</h3>
                  <p class="mb-0">Be a volunteer for our community and be social!</p>
                </div>
                <div class="card-body">
                  ...
                  <label>Email</label>
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Blood Group" id="bloodgroup" name="bloodgroup" aria-label="Bloodgroup" aria-describedby="Bloodgroup-addon">
                    </div>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0">Join Now!</button>
                    </div>
