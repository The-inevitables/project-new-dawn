...
PLACE YOUR CODE HERE!-->
    ...
    <!--The first container that contains all the contents-->
    ...
    <!--Main page-->
      <div class="main h-full flex">
           ...
           <!--main section-->
          <div class="main-section flex-1 p-6 w-40 bg-white">
              <div class="header">
                  <!--Adding the title-->
                  <h1 class="font-bold text-2xl text-gray-600 mb-6" >Shopping Cart</h1>
                  <!--Title tables -->
                  <div class="table-titles text-gray-600 flex font-bold">
                  ...
                  <div class="cart-items mt-5">
                      ...
                      <!--First Item-->
                      <div class="cart-item-1  flex items-center pb-4 border-b border-gray-150">

                        
                        <div class="cart-item-image w-48 h-24 bg-white p-4 rounded-lg ">
                            <img class="w-full h-full object-contain" src="https://m.media-amazon.com/images/I/71an9eiBxpL._SL1500_.jpg" alt="">
                        ...
                        <div class="cart-item-details flex-grow">
                            ...
                            <div class="cart-item-make text-sm text-gray-400">
                                Apple
                            </div>
                        ...
                        <div class="cart-item-counter w-48 flex items-center ">
                            ...
                            <div class="chevron-left mr-2 cursor-pointer items-center justify-center bg-gray-200 rounded flex text-black h-6 w-6">
                                <svg class="text-black h-100 w-100 hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div class="chevron-right ml-2 cursor-pointer items-center justify-center bg-gray-200 rounded flex text-black h-6 w-6">
                                <svg class="text-black h-100 w-100 hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div class="cart-item-total-cost w-48 font-bol text-gray-400">
                            ₹ 174,000  
                        </div>
  
                        <div class="cart-item-delete text-gray-4oo w-10 font-bold cursor-pointer hover:text-gray-500">

                            <svg class="text-black h-15 w-15 hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                      ...
                      <!--cart item2-->
                      <div class="cart-item-2  flex items-center pb-4 border-b border-gray-150">

                        
                        <div class="cart-item-image w-48 h-24 bg-white p-4 rounded-lg ">
                            <img class="w-full h-full object-contain" src="https://img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RE4FkjX?ver=c092&q=90&m=6&h=270&w=270&b=%23FFFFFFFF&f=jpg&o=f&aim=true" alt="">

                        </div>
                        
                        <div class="cart-item-details flex-grow">

                            <div class="cart-item-title mr-1 font-bold text-sm text-gray-600">
                                Xbox series S    
                            </div>
                        ...
                        <div class="cart-item-counter w-48 flex items-center ">
                            ...
                            <div class="chevron-left  mr-2 cursor-pointer items-center justify-center text-gray-400 h-6 w-6 bg-gray-200 rounded flex hover:bg-gray-200">
                                <svg class="text-black h-100 w-100 hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M15.707 15.707a1 1 0 01-1.414 0l-5-5a1 1 0 010-1.414l5-5a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 010 1.414zm-6 0a1 1 0 01-1.414 0l-5-5a1 1 0 010-1.414l5-5a1 1 0 011.414 1.414L5.414 10l4.293 4.293a1 1 0 010 1.414z" clip-rule="evenodd" />
                                </svg>
                            </div>
                        ...
                        <div class="cart-item-delete text-gray-400 w-10 font-bold cursor-pointer hover:text-gray-500">
                  ...
                  <!--Full total amount-->
                  <div class="cart-item-complete-order flex justify-end mt-5">


                      <div class="total-cost">
                          <h2 class="text-gray-400">Total cost</h2>
                          <div class="total-cost-number mr-7 text-gray-600 text-3xl font-bold">
                            ₹ 200,000
                          </div>
                      </div>
                      <div class="buy-now w-56 flex items-center justify-center bg-yellow-400 rounded cursor-pointer hover:bg-yellow-600">
                          Buy Now
                      </div>
                  </div>
              </div>
          ...
          <div class="sidebar border-t-2 border-r-2 border-opacity-20 border-gray-700 main-sidebar w-1.5/5 h-screen bg-white p-6">
            <!--Categories for side bar-->
              <div class="sidebar-categories">
                ...
                <div class="sidebar-main-category cursor-pointer flex font-bold text-black  mb-2 p-2 hover:bg-purple-200 rounded-xl bg-gradient-to-r from-gray-400 via-gray-300 to-gray-150.. ..  hover:from-green-400 hover:to-blue-500 hover:from-green-400 hover:to-blue-500">
                    ...
                    <span class="w-8 items-center justify-center">
                        <svg class="text-black"xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
